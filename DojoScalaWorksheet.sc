object DojoScalaWorksheet {
  ...
  val megaLista= List(List("Andres", "24 years", "male"),List("Juan", "23 years", "male"),List("Luz", "22 years", "female"))
                                                  //> megaLista  : List[List[String]] = List(List(Andres, 24 years, male), List(Ju
                                                  //| an, 23 years, male), List(Luz, 22 years, female))
  
  megaLista.filter{ x=> x(0)== "Juan"}            //> res5: List[List[String]] = List(List(Juan, 23 years, male))
